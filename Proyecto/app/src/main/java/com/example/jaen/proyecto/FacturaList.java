...
public class FacturaList extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.factura_list);
        // Inicializamos
        listado = (ListView)findViewById(android.R.id.list);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        menu.add(0, MENU_ID, 0, "Eliminar factura");
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case MENU_ID:
                ...
                dbHelper.deleteFactura(info.id);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Intent i = new Intent(this, GestionarFactura.class);
    ...
    /**
     * Cargamos los datos de la base de datos en el cursor y lo mostramos en el listView pasandolo primero por el adaptador.
     */
    public void cargarDatos() throws Exception {

        cursor = dbHelper.getTabla();
        startManagingCursor(cursor);
        CursorAdapterFactura adaptador = new CursorAdapterFactura(this, cursor);
